    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenanceGarages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarMaintenanceGarages", x => new { x.CarId, x.MaintenanceGarageId });
                    table.ForeignKey(
                        name: "FK_CarMaintenanceGarages_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarMaintenanceGarages_MaintenanceGarages_MaintenanceGarageId",
                        column: x => x.MaintenanceGarageId,
                        principalTable: "MaintenanceGarages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarMaintenanceGarages_MaintenanceGarageId",
                table: "CarMaintenanceGarages",
